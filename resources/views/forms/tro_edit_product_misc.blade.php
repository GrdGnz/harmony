                                    ...
                                    <div class="col-md-12 d-flex">
                                        <div class="col-md-6">
                                                ...
                                                <select class="form-control form-select txt-1" id="miscType" name="miscType">
                                                    @if(isset($miscRates))
                                                        @foreach ($miscRates as $type)
                                                            <option value="{{ $type->MISC_CODE }}" @if($type->MISC_CODE == $sfMisc->MISC_CODE) selected @endif>{{ $type->MISC_DESCR }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                                ...
                                                <select class="form-control form-select txt-1" id="miscServiceClass" name="miscServiceClass">
                                                    @if(isset($serviceClasses))
                                                        @foreach ($serviceClasses as $service)
                                                            <option value="{{ $service->SRVC_CLASS }}" @if($service->SRVC_CLASS == $sfMisc->SRVC_CLASS) selected @endif>{{ $service->SRVC_DESCR }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                                ...
                                                <select class="form-control form-select txt-1" id="miscStatus" name="miscStatus">
                                                    @if(isset($bookStatus))
                                                        @foreach ($bookStatus as $status)
                                                            <option value="{{ $status->BK_CODE }}" @if($status->BK_CODE == $sfMisc->BK_CODE) selected @endif>{{ $status->BK_DESCR }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                            <div class="form-group mt-2">
                                                ...
                                                <input type="date" id="miscStartDate" name="miscStartDate" class="form-control txt-1" min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" value="{{ \Carbon\Carbon::parse($sfMisc->START_DATE)->format('Y-m-d') }}">
                                            </div>
                                            <div class="form-group mt-2">
                                                <label for="miscStartLoc" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Start Location</label>
                                                <input type="text" id="miscStartLoc" name="miscStartLoc" class="form-control txt-1" value="{{ $sfMisc->START_LOC }}">
                                            </div>
                                            <div class="form-group mt-2">
                                                <label for="miscEndDate" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">*End Date</label>
                                                <input type="date" id="miscEndDate" name="miscEndDate" class="form-control txt-1" min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" value="{{ \Carbon\Carbon::parse($sfMisc->END_DATE)->format('Y-m-d') }}">
                                            </div>
                                            <div class="form-group mt-2">
                                                <label for="miscEndLoc" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">End Location</label>
                                                <input type="text" id="miscEndLoc" name="miscEndLoc" class="form-control txt-1" value="{{ $sfMisc->END_LOC }}">
                                            </div>
                                            <div class="form-group mt-2">
                                                <label for="miscRemarks" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Remarks</label>
                                                <textarea id="miscRemarks" name="miscRemarks" rows="4" class="form-control txt-1">{{ trim($sfMisc->REMARKS) }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                                ...
                                                <select class="form-control form-select txt-1" id="procCenter" name="procCenter">
                                                    @if(isset($processingCenters))
                                                        @foreach ($processingCenters as $proc)
                                                            <option value="{{ $proc->PROC_CODE }}" @if($proc->PROC_CODE == $sfMisc->PROC_CODE) selected @endif>{{ $proc->PROC_DESCR }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group mx-2 mt-2">
                                                ...
                                                <input type="text" class="form-control txt-1" id="miscConfNo" name="miscConfNo" value="{{ $sfGroup->CONF_NO }}">
                                            </div>
                                            <div class="form-group mx-2 mt-2">
                                                ...
                                                <input type="text" class="form-control txt-1" id="miscPaxRefNo" name="miscPaxRefNo" value="{{ $sfGroup->PAX_REF_NO }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
