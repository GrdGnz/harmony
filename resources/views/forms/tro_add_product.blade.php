                ...
                <div class="card-body marsman-bg-color-lightgray">
                    ...
                    <div class="row col-md-12 d-flex">
                        <div class="form-group col-md-6 mb-2">
                            <label for="productName" class="form-label marsman-bg-color-dark text-white p-2 m-0 rounded-top">Product Name</label>
                        ...
                        <div class="form-group col-md-3 mb-2">
                            <label for="category" class="form-label marsman-bg-color-dark text-white p-2 m-0 rounded-top">Category</label>
                            <select id="category" name="category" class="form-control form-select txt-1">
                                <option value="" selected="selected">-- Choose Category --</option>
                                @foreach ($productCategories as $category)
                                    <option value="{{ $category->prod_cat }}">{{ $category->prod_name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group col-md-3 mb-2">
                            <label for="route" class="form-label marsman-bg-color-dark text-white p-2 m-0 rounded-top">Route</label>
                    ...
                    <div class="tab-content">
                                ...
                                <div class="form-group col-md-6 mb-2">
                                        ...
                                        <div class="card-body">
                                            <div class="col-md-12 d-flex">
                                                <div class="form-group">
                                                    <label for="currencyCode" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Code</label>
                                                    <input type="text" class="form-control txt-1" id="currencyCode" name="currencyCode">
                                                </div>
                                                <div class="form-group col-md-8 mx-2">
                                                    <label for="currencyAmount" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Amount</label>
                                        ...
                                        <div class="card-body">
                                            <div class="col-md-12 d-flex">
                                                <div class="form-group col-md-6 mx-2">
                                                    <label for="unitAmount" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">*Unit Amount</label>
                                                    <input type="text" class="form-control txt-1" id="unitAmount" name="unitAmount" value="0">
                                                </div>
                                                <div class="form-group col-md-4 mx-2">
                                                    <label for="unitQuantity" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Quantity</label>
                                    ...
                                    <div class="card mt-2">
                                        ...
                                        <div class="card-body">
                                            <div class="col-md-12 d-flex">
                                                <div class="form-group col-md-6 mx-2">
                                                    <label for="discountRate" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Rate</label>
                                                    <input type="number" class="form-control txt-1" id="discountRate" name="discountRate" value="0">
                                                </div>
                                                <div class="form-group col-md-4 mx-2">
                                                    <label for="discountAmount" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Amount</label>
                                    ...
                                    <div class="card mt-2">
                                        ...
                                        <div class="card-body">
                                            <div class="col-md-12 d-flex">
                                                <div class="form-group col-md-6 mx-2">
                                                    <label for="commissionRate" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Rate</label>
                                                    <input type="number" class="form-control txt-1" id="commissionRate" name="commissionRate" value="0">
                                                </div>
                                                <div class="form-group col-md-4 mx-2">
                                                    <label for="commissionAmount" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Amount</label>
                                        ...
                                        <div class="card-body">
                                            <div class="col-md-12 d-flex mt-2">
                                                <div class="form-group col-md-4">
                                                    <label for="govTax" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Government Tax</label>
                                            ...
                                            <div class="col-md-12 mt-2">
                                                <div class="form-group">
                                                    <label for="govTaxCat" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Government Tax Category</label>
                                                    <select class="form-control form-select txt-1" id="govTaxCat" name="govTaxCat">
                                                        <option></option>
                                                    </select>
                                                </div>
                                                <div class="form-group mt-2">
                                                    <label for="taxes" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Taxes</label>
                                                    <input type="number" class="form-control txt-1 p-2" id="taxes" name="taxes" value="0">
                                                </div>
                                            </div>
                                            <div class="col-md-12 mt-2">
                                                <div class="form-group">
                                                    <label for="surcharge" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Surcharge</label>
                                                    <input type="text" class="form-control txt-1 p-2" id="surcharge" name="surcharge" value="0">
                                                </div>
                                            </div>
                                            <div class="col-md-12 d-flex mt-2">
                                                <div class="form-group col-md-6">
                                                    <label for="totalUnitAmount" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Total Unit Amount</label>
                                                    <input type="text" class="form-control txt-1 p-2" id="totalUnitAmount" name="totalUnitAmount" value="0">
                                                </div>
                                                <div class="form-group col-md-6 mx-2">
                                                    <label for="totalIncome" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Total Income</label>
                                                    <input type="text" class="form-control txt-1 p-2" id="totalIncome" name="totalIncome" value="0">
                                                </div>
                                            </div>
                                            <div class="col-md-12 d-flex mt-2">
                                                <div class="form-group col-md-6">
                                                    <label for="grandTotal" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Grand Total</label>
                                                    <input type="text" class="form-control txt-1 p-2" id="grandTotal" name="grandTotal" value="0">
                                                </div>
                                                <div class="form-group col-md-6 mx-2">
                                                    <label for="unitIncome" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Unit income</label>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="col-md-12 d-flex">
                                                <div class="form-group">
                                                    <label for="costCurrencyCode" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Code</label>
                                                    <input type="text" class="form-control txt-1" id="costCurrencyCode" name="costCurrencyCode">
                                                </div>
                                                <div class="form-group col-md-8 mx-2">
                                                    <label for="costCurrencyAmount" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Amount</label>
                                        ...
                                        <div class="card-body">
                                            <div class="col-md-12">
                                                <div class="form-group mb-2">
                                                    <label for="splFareCode" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Special Fare Code</label>
                                                    <input type="text" class="form-control txt-1" id="splFareCode" name="splFareCode">
                                                </div>
                                                <div class="form-group mb-2">
                                                    <label for="costPublishedRate" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Published Rate</label>
                                                    <input type="text" class="form-control txt-1" id="costPublishedRate" name="costPublishedRate">
                                                </div>
                                                <div class="form-group mb-2">
                                                    <label for="costNetRate" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Net Rate</label>
                                    ...
                                    <div class="card mt-2">
                                        ...
                                        <div class="card-body">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="nonAirNetRate" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Net Rate</label>
                                    ...
                                    <div class="card mt-2">
                                        ...
                                        <div class="card-body">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="costSupplier" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Supplier</label>
                                                    <select type="text" class="form-control form-select txt-1" id="costSupplier" name="costSupplier">
                                                        <option></option>
                                                    </select>
                                                </div>
                                                <div class="form-group my-2">
                                                    <label for="xoNumber" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Exchange Order Number</label>
                                                    <input type="text" class="form-control txt-1" id="xoNumber" name="xoNumber">
                                                </div>
                                                <div class="form-group">
                                                    <label for="account" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Account</label>
                                    ...
                                    <div class="card mt-2">
                                        ...
                                        <div class="card-body">
                                            <div class="col-md-12 d-flex">
                                                <div class="form-group col-md-6 mb-2">
                                                    <label for="costDiscountRate" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Rate</label>
                                                ...
                                                <div class="form-group col-md-6 mb-2 mx-2">
                                                    <label for="costDiscountAmount" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Amount</label>
                                    ...
                                    <div class="card mt-2">
                                        ...
                                        <div class="card-body">
                                            <div class="col-md-12 d-flex">
                                                <div class="form-group col-md-6 mb-2">
                                                    <label for="costCommissionRate" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Rate</label>
                                                    <input type="text" class="form-control txt-1" id="costCommissionRate" name="costCommissionRate">
                                                </div>
                                                <div class="form-group col-md-6 mb-2 mx-2">
                                                    <label for="costCommissionAmount" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Amount</label>
                                    ...
                                    <div class="card mt-2">
                                        ...
                                        <div class="card-body">
                                            <div class="col-md-12">
                                                <div class="form-group mb-2">
                                                    <label for="costInsurance" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Insurance</label>
                                                    <input type="text" class="form-control txt-1" id="costInsurance" name="costInsurance">
                                                </div>
                                                <div class="form-group mb-2">
                                                    <label for="costTaxes" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Taxes</label>
                                                    <input type="text" class="form-control txt-1" id="costTaxes" name="costTaxes">
                                                </div>
                                            </div>
                                            <div class="form-group d-flex mb-2">
                                                <div class="form-group col-md-6 mb-2">
                                                    <label for="costTotalUnitCost" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Total Unit Cost</label>
                                                ...
                                                <div class="form-group col-md-4 mb-2 mx-2">
                                                    <label for="costUnitQuantity" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Quantity.</label>
                                                    <input type="number" class="form-control txt-1" id="costUnitQuantity" name="costUnitQuantity" value="0">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="costGrandTotal" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Grand Total</label>
                                    ...
                                    <div class="card mt-2">
                                        ...
                                        <div class="card-body">
                                            <div class="col-md-12">
                                                <div class="form-group mb-2">
                                                    <label for="tourCode" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Tour Code</label>
                                                    <input type="text" class="form-control txt-1" id="tourCode" name="tourCode">
                                                </div>
                                            </div>
                                            <div class="col-md-12 mb-2">
                                                <div class="form-group mb-2">
                                                    <label for="mpdMco" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">MPD / MCO</label>
                                                    <input type="text" class="form-control txt-1" id="mpdMco" name="mpdMco">
                                                </div>
                                            </div>
                                            <div class="col-md-12 mb-2">
                                                <div class="form-group">
                                                    <label for="voucherNumber" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Voucher Number</label>
                                ...
                                <div class="form-group col-md-6">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="col-md-12">
                                                <div class="form-group mb-2">
                                                    <label for="hotelCode" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">*Hotel</label>
                                                ...
                                                <div class="col-md-12 d-flex">
                                                    <div class="form-group col-md-6 mx-1 my-1">
                                                        <label for="checkInDate" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">*Check-in Date</label>
                                                        <input type="date" class="form-control txt-1" id="checkInDate" name="checkInDate">
                                                    </div>
                                                    <div class="form-group col-md-4 mx-1 my-1">
                                                        <label for="hotelNights" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Number of Nights</label>
                                                        <input type="number" class="form-control txt-1" id="hotelNights" name="hotelNights" value="0" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-12 d-flex">
                                                    <div class="form-group col-md-6 mx-1 my-1">
                                                        <label for="checkOutDate" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">*Check-in Date</label>
                                                        <input type="date" class="form-control txt-1" id="checkOutDate" name="checkOutDate">
                                                    </div>
                                                    <div class="form-group col-md-4 mx-1 my-1">
                                                        <label for="roomQuantity" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Room Quantity</label>
                                                ...
                                                <div class="col-md-12 d-flex">
                                                    <div class="form-group col-md-8 mx-1 my-1">
                                                        <label for="roomType" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Room Type</label>
                                                ...
                                                <div class="col-md-12 d-flex">
                                                    <div class="form-group col-md-8 mx-1 my-1">
                                                        <label for="roomCategory" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Room Category</label>
                                                ...
                                                <div class="col-md-12 d-flex">
                                                    <div class="form-group col-md-8 mx-1 my-1">
                                                        <label for="bookStatus" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">*Status</label>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group col-md-12 mx-1 my-1">
                                                <label for="hotelBreakfast" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Breakfast</label>
                                            ...
                                            <div class="form-group col-md-12 mx-1 my-1">
                                                <label for="hotelLunch" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Lunch</label>
                                            ...
                                            <div class="form-group col-md-12 mx-1 my-1">
                                                <label for="hotelDinner" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Dinner</label>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="col-md-12 d-flex">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="confNo" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Confirmation Number</label>
                                                    <input type="text" class="form-control txt-1" id="confNo" name="confNo">
                                                </div>
                                                <div class="form-group mt-2">
                                                    <label for="paxRefNo" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Passenger Reference Number</label>
                                                    <input type="text" class="form-control txt-1" id="paxRefNo" name="paxRefNo">
                                                </div>
                                                <div class="form-group col-md-2 mt-2">
                                                    <label for="numberOfGuest" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Number of Guest</label>
                                                    <input type="number" class="form-control txt-1" id="numberOfGuest" name="numberOfGuest" value="0">
                                                </div>
                                            </div>
                                            <div class="col-md-6 mx-2">
                                                <div class="form-group">
                                                    <label for="otherServices" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Other Services</label>
                                                    <input type="text" class="form-control txt-1" id="otherServices" name="otherServices">
                                                </div>
                                                <div class="form-group mt-2">
                                                    <label for="hotelRemarks" class="form-label marsman-bg-color-dark text-white txt-1 p-2 m-0 rounded-top">Remarks</label>
                                                    <textarea class="form-control txt-1" id="hotelRemarks" name="hotelRemarks" rows="5"></textarea>
                                                </div>

                                                <div class="form-group col-md-12 mx-1 my-1">
                                                    <button type="button" id="submitHotelForm" class="btn btn-primary">Save</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="tab-pane fade show" id="mis" role="tabpanel" aria-labelledby="mis-tab">
                            ...
                            <div class="row col-md-12 d-flex mt-2">
                                <div class="form-group col-md-6">
                                    <label for="gds" class="form-label marsman-bg-color-dark text-white p-2 m-0 rounded-top">GDS</label>
                                    ...
                                    <div class="card mt-2">
                                        ...
                                        <div class="card-body">
                                            <label for="bookLocation" class="form-label marsman-bg-color-dark text-white p-2 m-0 rounded-top">Location</label>
                                            <input type="text" id="bookLocation" name="bookLocation" class="form-control txt-1">
                                            <label for="bookUser" class="form-label marsman-bg-color-dark text-white p-2 m-0 rounded-top mt-2">User ID</label>
                                            <input type="text" id="bookUser" name="bookUser" class="form-control txt-1">
                                            <label for="bookDate" class="form-label marsman-bg-color-dark text-white p-2 m-0 rounded-top mt-2">Date</label>
                                    ...
                                    <div class="card mt-2">
                                        ...
                                        <div class="card-body">
                                            <label for="issueLocation" class="form-label marsman-bg-color-dark text-white p-2 m-0 rounded-top">Location</label>
                                            <input type="text" id="issueLocation" name="issueLocation" class="form-control txt-1">
                                            <label for="issueUser" class="form-label marsman-bg-color-dark text-white p-2 m-0 rounded-top mt-2">User ID</label>
                                            <input type="text" id="issueUser" name="issueUser" class="form-control txt-1">
                                            <label for="issueDate" class="form-label marsman-bg-color-dark text-white p-2 m-0 rounded-top mt-2">Date</label>
                                    ...
                                    <div class="card mt-2 mb-2">
                                        <div class="card-body">
                                            <div class="p-2">
                                                ...
                                                <div class="form-group mt-2">
                                                    <label for="region" class="form-label marsman-bg-color-dark text-white p-2 m-0 rounded-top">Region</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6 mb-2">
                                            <label for="admAlloc" class="form-label marsman-bg-color-dark text-white p-2 m-0 rounded-top">ADM Allocation</label>
                                            <input type="text" id="admAlloc" name="admAlloc" class="form-control txt-1">
                                        </div>
                                        <div class="form-group col-md-6 mb-2">
                                            <label for="lowestFare" class="form-label marsman-bg-color-dark text-white p-2 m-0 rounded-top">Lowest Fare</label>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6 mb-2">
                                            <label for="staffDiscount" class="form-label marsman-bg-color-dark text-white p-2 m-0 rounded-top">Staff Discount</label>
                                            <input type="text" id="staffDiscount" name="staffDiscount" class="form-control txt-1">
                                        </div>
                                        <div class="form-group col-md-6 mb-2">
                                            <label for="fareSaving" class="form-label marsman-bg-color-dark text-white p-2 m-0 rounded-top">Fare Saving</label>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="form-group col-md-6 mb-2">
                                                    <label for="embarkationLoc" class="form-label marsman-bg-color-dark text-white p-2 m-0 rounded-top">Embarkation Location</label>
                                                    <input type="text" id="embarkationLoc" name="embarkationLoc"s class="form-control txt-1">
                                                </div>
                                                <div class="form-group col-md-6 mb-2">
                                                    <label for="embarkationLoc" class="form-label bg-white text-white p-2 m-0 rounded-top">Embarkation Location</label>
...
<script>
    document.addEventListener('DOMContentLoaded', (event) => {
        ...
        //HOTEL Form1
        $('#submitHotelForm').on('click', function() {
            var formData = {
