                                                        ...
                                                        <select id="carProvider" name="carProvider" class="form-control form-select txt-1">
                                                            @if (isset($carSupplier))
                                                                @foreach ($carSupplier as $supplier)
                                                                    <option value="{{ $supplier->SUPP_ID }}" @if($supplier->SUPP_ID == $sfTransfer->CAR_PROVIDER) selected @endif>{{ $supplier->SUPP_NAME }}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                    </div>
                                                        ...
                                                        <select id="carType" name="carType" class="form-control form-select txt-1">
                                                            @if(isset($carTypes))
                                                                @foreach ($carTypes as $type)
                                                                    <option value="{{ $type->CAR_CODE }}"  @if($type->CAR_CODE == $sfTransfer->CAR_TYPE) selected @endif>{{ $type->CAR_DESCR }}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                    </div>
                                                        ...
                                                        <select id="carCategory" name="carCategory" class="form-control form-select txt-1">
                                                            @if(isset($carCategories))
                                                                @foreach ($carCategories as $category)
                                                                    <option value="{{ $category->CAR_CAT }}" @if($category->CAR_CAT == $sfTransfer->CAR_CAT) selected @endif>{{ $category->CAR_DESCR }}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                    </div>
                                                    <div class="form-group mt-2">
                                                        ...
                                                        <select id="carStatus" name="carStatus" class="form-control form-select txt-1">
                                                            @foreach ($bookStatus as $status)
                                                                <option value="{{ $status->BK_CODE }}" @if($status->BK_CODE == $sfTransfer->STATUS) selected @endif>{{ $status->BK_DESCR }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card-body marsman-bg-color-gray1">
                                                    <div class="col-md-12 d-flex">
                                                        <div class="form-group col-md-6 p-1">
                                                            ...
                                                            <input type="date" class="form-control txt-1" id="pickUpDate" name="pickUpDate" value="{{ \Carbon\Carbon::parse($sfTransfer->PICK_DATE)->format('Y-m-d') }}">
                                                        </div>
                                                        <div class="form-group col-md-6 p-1">
                                                            <label for="pickUpTime" class="form-label marsman-bg-color-label text-white txt-1 p-2 m-0 rounded-top">Time</label>
                                                            <input type="text" class="form-control txt-1" id="pickUpTime" name="pickUpTime" placeholder="1200" value="{{ $sfTransfer->PICK_TIME }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group mt-2 p-2">
                                                            ...
                                                            <input type="text" class="form-control txt-1" id="pickUpLocation" name="pickUpLocation" value="{{ $sfTransfer->PICK_LOC }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card-body marsman-bg-color-gray1">
                                                    <div class="col-md-12 d-flex">
                                                        <div class="form-group col-md-6 p-1">
                                                            ...
                                                            <input type="date" class="form-control txt-1" id="dropoffDate" name="dropoffDate" value="{{ \Carbon\Carbon::parse($sfTransfer->DROP_DATE)->format('Y-m-d') }}">
                                                        </div>
                                                        <div class="form-group col-md-6 p-1">
                                                            <label for="dropoffTime" class="form-label marsman-bg-color-label text-white txt-1 p-2 m-0 rounded-top">Time</label>
                                                            <input type="text" class="form-control txt-1" id="dropoffTime" name="dropoffTime" placeholder="1200" value="{{ $sfTransfer->DROP_TIME }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group mt-2 p-2">
                                                            <label for="dropoffLocation" class="form-label marsman-bg-color-label text-white txt-1 p-2 m-0 rounded-top">Location</label>
                                                            <input type="text" class="form-control txt-1" id="dropoffLocation" name="dropoffLocation" value="{{ $sfTransfer->DROP_LOC }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card-body marsman-bg-color-gray1">
                                                    <div class="row col-md-12">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control txt-1" id="carCity" name="carCity" value="{{ $sfTransfer->CITY_CODE }}">
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                            <label for="carArrival" class="form-label marsman-bg-color-label text-white txt-1 p-2 m-0 rounded-top">Arrival</label>
                                                            <input type="text" class="form-control txt-1" id="carArrival" name="carArrival" value="{{ $sfTransfer->MOVE_TIME }}">
                                                        </div>
                                                        <div class="form-group mt-2">
                                                            ...
                                                            <input type="text" class="form-control txt-1" id="carFlightNumber" name="carFlightNumber" value="{{ $sfTransfer->FLIGHT_NUM }}">
                                                        </div>
                                                        <div class="form-group mt-2">
                                                            ...
                                                            <input type="text" class="form-control txt-1" id="carSpecialRequest" name="carSpecialRequest" value="{{ $sfTransfer->SPECIAL_REQUEST }}">
                                                        </div>
                                                        <div class="form-group mt-2">
                                                            ...
                                                            <input type="text" class="form-control txt-1" id="pickupPhoneNumber" name="pickupPhoneNumber" value="{{ $sfTransfer->PHONE_NO }}">
                                                        </div>
                                                        <div class="form-group mt-2">
                                                            ...
                                                            <input type="text" class="form-control txt-1" id="transferPaxRefNo" name="transferPaxRefNo" value="{{ $sfGroup->PAX_REF_NO }}">
                                                        </div>
                                                        <div class="form-group mt-2">
                                                            ...
                                                            <input type="text" class="form-control txt-1" id="transferConfNo" name="transferConfNo" value="{{ $sfGroup->CONF_NO }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card mt-2">
                                                ...
                                                <div class="card-body marsman-bg-color-gray1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control txt-1" id="stopoverFirst" name="stopoverFirst" value="{{ $sfTransfer->STOP_OVER_1 }}">
                                                    </div>
                                                    <div class="form-group mt-2">
                                                        <label for="stopoverSecond" class="form-label marsman-bg-color-label text-white txt-1 p-2 m-0 rounded-top">Second</label>
                                                        <input type="text" class="form-control txt-1" id="stopoverSecond" name="stopoverSecond" value="{{ $sfTransfer->STOP_OVER_2 }}">
                                                    </div>
                                                    <div class="form-group mt-2">
                                                        <label for="stopoverThird" class="form-label marsman-bg-color-label text-white txt-1 p-2 m-0 rounded-top">Third</label>
                                                        <input type="text" class="form-control txt-1" id="stopoverThird" name="stopoverThird" value="{{ $sfTransfer->STOP_OVER_3 }}">
                                                    </div>
                                                </div>
                                            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', (event) => {
        ...
        $('#updateProduct').click(function(e) {
            ...
            //SalesFolderTransfer data
            var carProvider = $('#carProvider').val();
            var carType = $('#carType').val();
            var carCategory = $('#carCategory').val();
            var carFlightNumber = $('#carFlightNumber').val();
            ...
            var stopoverFirst = $('#stopoverFirst').val();
            var stopoverSecond = $('#stopoverSecond').val();
            var stopoverThird = $('#stopoverThird').val();
            var pickupPhoneNumber = $('#pickupPhoneNumber').val();
            var carSpecialRequest = $('#carSpecialRequest').val();
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.ajax({
                        url: '{{ route('sales-folder-transfer.update') }}',
                        type: 'POST',
                        dataType: 'json',
                        data: {
                            _token: '{{ csrf_token() }}',
                            ...
                            carFlightNumber: carFlightNumber,
                            ...
                            stopoverFirst: stopoverFirst,
                            stopoverSecond: stopoverSecond,
                            stopoverThird: stopoverThird,
                            pickupPhoneNumber: pickupPhoneNumber,
                            carSpecialRequest: carSpecialRequest,
                            carStatus: carStatus,
                        },
                        success: function(response) {
                            console.log('Car/Transfer product update successful:', response);
                            alert('Update successful');
                            // Optionally handle success actions here
                        },
                        error: function(xhr, status, error) {
                            console.error('Car/Transfer update error:', error);
                            alert('Failed to update Car/Transfer product');
